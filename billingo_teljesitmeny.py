...
FONTOS — a BID párosítás felépítése (2026-08-14, Billingo-váltás után):
  ...
  munka a partnernél. A legmagasabb pontszám nyer küszöb felett; idegen
  partnerhez sosem tippel.
...
def _collect_month(month: str):
    ...
    # Két független BID-forrás: Innonest megrendelőlapok (Playwright) és
    # Pipedrive üzletek (sima API). Ha az egyik elhasal, a másik viszi a párosítást.
    try:
        sheets = _get_ordersheets()
    except Exception as e:
