...
- EMAIL_WEBAPP_URL               (a "SQM Email Küldő" Apps Script Web App URL-je - a fotózási útmutató email küldéséhez, ugyanaz mint a visszajelző emailnél)
- EMAIL_WEBAPP_SECRET            (a "SQM Email Küldő" script titkos kulcsa - a doPost ezt megköveteli a body-ban, ugyanaz mint a visszajelző emailnél)
