...
tartalmazza — az üzleti logika külön modulokban van:
  ...
  billingo_teljesitmeny.py – /ertekesito-teljesitmeny (Billingo → Pipedrive owner)
...
# 8. Értékesítői teljesítmény (Billingo számlák → Pipedrive owner) regisztrálása
from billingo_teljesitmeny import register_teljesitmeny_routes
register_teljesitmeny_routes(app)
