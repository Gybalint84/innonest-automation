...
async def get_arajanlat_tetelek(page, bid: str) -> dict:
    ...
    try:
        ...
        await page.wait_for_timeout(3000)  # Várunk hogy a JS kiszámolja az összegeket
        ...
        tetelek = await page.evaluate("""
            () => {
                ...
                sorok.forEach(tr => {
                    ...
                    // Nettó összesen: readonly input[name^="nettPrice"]
        ...
        # ── 5. Nettó végösszeg kinyerése – input.fullTotalNett ──
        netto_js = await page.evaluate("""
            () => {
                // A végösszeg egy readonly input class="fullTotalNett"
                ...
                // Fallback: tfoot-ban lévő első nagy szám input
